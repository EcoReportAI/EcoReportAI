    ...
    const GreenData = [
        {
            ...
            answer:'A technology platform for certifying green projects, buying carbon credits and tracking sustainability with transparency.'
        },
        {
            id: 2,
            question: 'How do I get started as a developer?',
            answer:'Sign up, submit your project and start the certification process.'
        },
        {
            id: 3,
            question: 'How can I buy carbon credits?',
            answer:'Browse verified projects and purchase credits that align with your goals.'
        },
        {
            id: 4,
            question: 'How can municipalities use Green-Badge?',
            answer:'Track city-wide sustainability, create policies and engage developers to meet goals.'
        }
                ...
                <div className="header pt-[60px] pl-[80px] text-black bg-gradient-to-b from-[#03FF95] to-[#011F29] sm:pl-[30px] md:pl-[30px] lg:pl-[80px]" data-aos="fade-down">
                    <div className='flex justify-center items-center flex-row sm:items-start md:items-start lg:items-center sm:flex-col md:flex-col lg:flex-row'>
                        <div className="pt-[40px] w-[70%] sm:w-[90%] md:w-[70%] lg:w-[70%]">
                            <h2 className="h mb-2 text-[50px] text-white leading-[60px] font-bold mb-[30px] w-[85%]  sm:w-full md:w-[98%] lg:w-[85%] sm:text-[25px] md:text-[32px] sm:leading-[30px] md:leading-[40px] lg:text-[50px] lg:leading-[60px]">Empower Your Green Projects with Verified Impact</h2>
                            <p className='w-[85%] text-white font-bold text-bold text-[17px] mb-7 sm:text-[15px] md:text-[16px] lg:text-[16px] sm-full md:w-full lg:w-[85%] sm:text-[13px] md:text-[14px] lg:text-[17px]'>Green-Badge empowers municipaities, project owners and investors to collaborate on sustainable initiatives, offering project certification, real-time impact tracking and a trusted marketplace for green investments to drive measurable environmental, social and economic progress.</p>
                        ...
                        <img src="/src/assets/images/image_fx_ (5) 1.webp" className='w-[35%] md:w-[40%] lg:w-[35%] sm:hidden md:hidden lg:flex' alt="" />
                    </div>
                </div>
            </section>
            {/* How it works */}
                    ...
                    <div className="flex pt-[30px] pb-[40px] justify-center items-center flex-row sm:flex-col md:flex-col lg:flex-row lg:flex" data-aos="fade-right">
                        <div className="bg-green-100 rounded-md pt-[20px] w-[35%] mr-[40px] shadow-md mb-0 sm:mr-[10px] md:mr-[10px] lg:mr-[40px] sm:mb-[20px] md:mb-[20px] sm:w-[95%] md:w-[60%] lg:w-[35%]">
                            <div className="px-[30px]">
                                <img className="w-[20%]" src="/src/assets/icons/wired-gradient-948-stock-share 1.webp" alt="" />
                            ...
                            <img className="" src="/src/assets/images/Rectangle 10.webp" alt="" />
                        </div>
                        <div className="bg-green-100 rounded-md pt-[20px] w-[35%] mr-[40px] shadow-md mb-0 sm:mr-[10px] md:mr-[10px] lg:mr-[40px] sm:mb-[20px] md:mb-[20px] sm:w-[95%] md:w-[60%] lg:w-[35%]">
                            <div className="px-[30px]">
                                <img className="w-[20%]" src="/src/assets/icons/wired-gradient-948-stock-share 1 (1).webp" alt="" />
                            ...
                            <img className="object-fill" src="/src/assets/images/h2.webp" alt="" />
                        </div>
                        <div className="bg-green-100 rounded-md pt-[20px] w-[35%] mr-[40px] shadow-md sm:mr-[10px] md:mr-[10px] lg:mr-[40px] sm:w-[95%] md:w-[60%] lg:w-[35%]">
                            <div className="px-[30px]">
                                <img className="w-[20%]" src="/src/assets/icons/wired-gradient-948-stock-share 1 (2).webp" alt="" />
                            ...
                            <img className="object-fill" src="/src/assets/images/Rectangle 10 (2).webp" alt="" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section>
                ...
                <div className="flex py-[2px] px-[80px] w-[87%] flex-row relative top-[-300px] left-[5%] sm:px-[20px] md:px-[20px] lg:px-[80px] sm:top-[-100px] md:top-[-100px] lg:top-[-300px] sm:flex-col md:flex-col lg:flex-row" data-aos="fade-right">
                    <div className="bg-[#358019] flex justify-center items-center flex-col px-[20px] py-[20px] w-[50%] rounded-l-lg sm:mb-[10px] md:mb-[10px] lg:mb-0 sm:w-full md:w-[80%] lg:w-[50%]">
                        <img className="w-[28%] mb-[20px]" src="/src/assets/icons/wired-outline-2665-logo-circle-bitcoin-hover-pinch 1.webp" alt="" />
                    ...
                    <div className="bg-[#4BB022] flex justify-center items-center flex-col px-[20px] py-[20px] w-[50%] sm:mb-[10px] md:mb-[10px] lg:mb-0 sm:w-full md:w-[80%] lg:w-[50%]">
                        <img className="w-[28%] mb-[20px]" src="/src/assets/icons/wired-outline-2665-logo-circle-bitcoin-hover-pinch 1 (1).webp" alt="" />
                    ...
                    <div className="bg-[#FBD048] text-black flex justify-center items-center flex-col px-[20px] py-[20px] w-[50%] sm:mb-[10px] md:mb-[10px] lg:mb-0 sm:w-full md:w-[80%] lg:w-[50%]">
                        <img className="w-[28%] mb-[20px]" src="/src/assets/icons/wired-outline-2665-logo-circle-bitcoin-hover-pinch 2.webp" alt="" />
                    ...
                    <div className="bg-[#D9D9D9] text-[#070707] flex justify-center items-center flex-col px-[20px] py-[15px] w-[50%] rounded-r-lg pb-[70px] sm:mb-[10px] md:mb-[10px] lg:mb-0 sm:w-full md:w-[80%] lg:w-[50%]">
                        <img className="w-[28%] mb-[20px]" src="/src/assets/icons/wired-outline-2665-logo-circle-bitcoin-hover-pinch 3.webp" alt="" />
                ...
                <div  className="px-[80px] mb-[30px] sm:px-[25px] md:px-[20px] lg:px-[80px]">
                    ...
                    <div className="flex border bg-gradient-to-r from-[#011F29] to-[#03FF95] rounded-md pt-[30px] pl-[70px] pr-[5px] mt-[30px] sm:pl-[20px] md:pl-[20px] lg:pl-[70px] sm:flex-col md:flex-col lg:flex-row">
                        ...
                        <div className='text-[12px] flex w-[120%] sm:flex-col md:flex-col lg:flex-row'>
                            <a href="/" rel="noopener noreferrer"><button  className="px-[20px] py-[5px] border-none mr-[20px] text-white bg-gradient-to-r from-[#03FF95] to-[#008890] rounded-[4px] sm:mb-[10px] md:mb-[10px] lg:mb-0" type="button">For Municipal</button></a>
                            <a href="/" rel="noopener noreferrer"><button  className="px-[20px] py-[5px] border-none mr-[20px] text-white bg-gradient-to-r from-[#03FF95] to-[#008890] rounded-[4px] sm:mb-[10px] md:mb-[10px] lg:mb-0" type="button">Project Developer</button></a>
                ...
                <div className="px-[80px] mb-[30px] bg-[#E6FFF4] py-[30px] sm:px-[20px] md:px-[20px] lg:px-[80px]">
                    ...
                    <div className="flex justify-center items-center flex-row mt-[30px] sm:flex-col md:flex-col lg:flex-row">
                        <div className="flex justify-center items-center flex-row sm:flex-col md:flex-col lg:flex-row sm:items-start sm:justify-start md:items-start md:justify-start lg:items-center lg:justify-center">
                            <img className="w-[30%] mt-[30px]" src="/src/assets/images/Rectangle 20.webp" alt="" />
                            <div className="ml-[20px] sm:ml-0 md:ml-0 lg:ml-[20px] sm:mt-[20px] md:mt-[20px] lg:mt-0">
                                <img className="w-[20%] mb-[20px]" src="/src/assets/icons/Review.webp" alt="" />
                        ...
                        <div className="flex justify-center items-center sm:flex-col md:flex-col lg:flex-row sm:items-start sm:justify-start md:items-start md:justify-start lg:items-center lg:justify-center">
                            <img className="w-[25%] mt-[30px]" src="/src/assets/images/Rectangle 21.webp" alt="" />
                            <div className="ml-[20px] sm:ml-0 md:ml-0 lg:ml-[20px] sm:mt-[20px] md:mt-[20px] lg:mt-0">
                                <img className="w-[20%] mb-[20px]" src="/src/assets/icons/Review.webp" alt="" />
                    ...
                    <div className="flex pt-[30px] pb-[10px] justify-center items-center flex-row sm:flex-col md:flex-col lg:flex-row" data-aos="fade-right">
                        <div className="rounded-md pt-[20px] w-[25%] mr-[40px] shadow-md border-[#03FF95] border sm:mb-[20px] md:mb-[20px] lg:mb-0 sm:mr-0 md:mr-0 lg:mr-[40px] sm:w-[90%] md:w-[50%] lg:w-[25%]">
                            <div className="flex justify-center flex-col items-center">
                                ...
                                <h2 className="font-bold text-[#14192B] text-[35px] my-[20px]">$49<span className="font-normal text-[18px]">/Month</span></h2>
                                <hr className="w-full" />
                                <ul className="text-black text-[14px] space-y-2 mb-[20px] ml-[20px] px-[30px] mt-[30px]">
                                    <li className="list-disc"><strong>Free:</strong> Basic project submission and documentation.</li>
                                    <li className="list-disc"><strong>Premium Plan:</strong> Includes advanced analytics and boosted visibility.</li>
                                </ul>
                        ...
                        <div className="rounded-md bg-gradient-to-r from-[#143E14] to-[#6FB432] pt-[20px] w-[25%] mr-[40px] shadow-md border-[#03FF95] border sm:mb-[20px] md:mb-[20px] lg:mb-0 sm:mr-0 md:mr-0 lg:mr-[40px] sm:w-[90%] md:w-[50%] lg:w-[25%]">
                            <div className="flex justify-center flex-col items-center text-white">
                                ...
                                <h2 className="font-bold text-[35px] my-[20px]">$199<span className="font-normal text-[18px]">/Month</span></h2>
                                <hr className="w-full" />
                                ...
                                <a href="/" rel="noopener noreferrer"><button  className="px-[45px] py-[13px] mb-[30px] border-none text-[#29591B] bg-white rounded-[10px] sm:mb-[20px] md:mb-[20px] lg:mb-[35px]" type="button">Get Started</button></a>
                            </div>
                        </div>
                        <div className="rounded-md pt-[20px] w-[25%] mr-[40px] shadow-md border-[#03FF95] border sm:mb-[20px] md:mb-[20px] lg:mb-0 sm:mr-0 md:mr-0 lg:mr-[40px] sm:w-[90%] md:w-[50%] lg:w-[25%]">
                            <div className="flex justify-center flex-col items-center">
                                ...
                                <p className="text-[#4B5262] text-[15px] mt-[10px]">Customer Reach & Budget</p>
                                <h2 className="font-bold text-[#14192B] text-[35px] my-[20px]">$250<span className="font-normal text-[18px]">/Month</span></h2>
                                <hr className="w-full" />
                                <ul className="text-black text-[14px] mb-[10px] ml-[20px] px-[30px] mt-[30px]">
                                    <li className="list-disc"><strong>Basic Plan:</strong> Certify a limited number of projects annually.</li>
                                    <li className="list-disc"><strong>Enterprise Plan:</strong> Advanced tools for tracking, impact reporting and project management.</li>
                                </ul>
                                    ...
                                    <AccordionItemHeading>
                                        <AccordionItemButton className="">
                                            <div className="px-[290px] text-[#444C66] flex justify-between items-center w-[90%]  mb-[30px] sm:px-[20px] md:px-[20px] lg:px-[290px]">
                                                ...
                                                <img className={!openAccordion ? 'rotate-0 w-[4%]' : 'rotate-[180deg] w-[4%]'} src="/src/assets/icons/bottom.png" alt="" />
